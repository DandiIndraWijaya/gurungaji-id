<div class="container">
    ...
    <div class="cardcss" style="width: 50%">
        <center>
            <h3 style="color: grey">Daftar menjadi murid di  <img height="40" width="100" src="<?= base_url('assets/images/ngaji/Ngaji.png') ?>" alt=""></h3>
        </center>
    </div>

    <form action="<?= base_url() ?>auth/daftar_murid" method="POST">
        <div class="row">
